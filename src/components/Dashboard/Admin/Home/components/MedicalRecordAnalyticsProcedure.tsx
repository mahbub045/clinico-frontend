...
import { useGetMedicalRecordAnalyticsProcedureQuery } from "@/redux/reducers/Admin/Home/MedicalRecordAnalyticsApi";
import { ProcedureAnalyticsPoint } from "@/types/Admin/Home/DashboardDataTypes";
...
const getExtreme = (
  data: ProcedureAnalyticsPoint[],
  key: keyof ProcedureAnalyticsPoint,
...
const MedicalRecordAnalyticsProcedure: React.FC = () => {
  const { data, isLoading, isError } =
    useGetMedicalRecordAnalyticsProcedureQuery(undefined);
  const chartData: ProcedureAnalyticsPoint[] = data ?? [];
            ...
            <div className="space-y-5">
              ...
              <div className="grid gap-4 xl:grid-cols-[0.9fr_0.85fr]">
                ...
                <div className="border-border/70 bg-muted/80 rounded-[1.75rem] border p-5 dark:border-slate-800 dark:bg-slate-950/80">
                  ...
                  <p className="text-muted-foreground mt-2 text-sm">
                    Highest average procedure cost
                  </p>
                </div>
              </div>
            </div>
...
export default MedicalRecordAnalyticsProcedure;
